...
extern int picokey_aes_encrypt(const uint8_t *key, const uint8_t *iv, uint16_t key_size, int mode, uint8_t *data, uint16_t len);
extern int picokey_aes_decrypt(const uint8_t *key, const uint8_t *iv, uint16_t key_size, int mode, uint8_t *data, uint16_t len);
#ifdef ESP_PLATFORM
#define aes_encrypt picokey_aes_encrypt
#define aes_decrypt picokey_aes_decrypt
#else
#define aes_encrypt picokey_aes_encrypt
#define aes_decrypt picokey_aes_decrypt
#endif
